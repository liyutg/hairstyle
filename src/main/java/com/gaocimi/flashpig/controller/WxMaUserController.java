...
//        WxPayUnifiedOrderResult result = ;
    ...
    public String parseOrderNotifyResult(@RequestBody String xmlData) throws WxPayException {
        ...
        System.out.println("支付成功，支付者openid： "+notifyResult.getOpenid());
        System.out.println("支付成功，订单号id： "+notifyResult.getOutTradeNo());
        System.out.println("支付成功，订单号金额： "+notifyResult.getTotalFee());
