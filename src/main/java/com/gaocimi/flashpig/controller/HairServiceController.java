...
@RestController
@ResponseResult
@Api(value = "管理端发型服务服务",description = "管理员操作发型服务相关业务")
public class HairServiceController {
    @Autowired
    IHairServiceService hairServiceService;
    ...
    public Page<HairService> getPage(@RequestParam(name="pageNum",defaultValue="1") int pageNum,
